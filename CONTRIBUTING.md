...
```sh
$ pip install git+ssh://git@github.com/omar-orrantia/Never-Fret-listen-to-Sin-Estres.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/omar-orrantia/Never-Fret-listen-to-Sin-Estres/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
