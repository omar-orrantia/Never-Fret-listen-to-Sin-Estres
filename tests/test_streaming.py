...
from strezless_musick_nexus_metadata._streaming import Stream, AsyncStream, ServerSentEvent


@pytest.mark.asyncio
@pytest.mark.parametrize("sync", [True, False], ids=["sync", "async"])
async def test_basic(
    sync: bool, client: StrezlessMusickNexusMetadata, async_client: AsyncStrezlessMusickNexusMetadata
) -> None:
